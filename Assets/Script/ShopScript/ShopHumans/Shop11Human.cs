...
public class Shop11Human : MonoBehaviour {
	...
	public void OnClicking(){
		...
		if(isPressUp == true){
			...
			//確認画面でヒトの画像を表示する
			ShopStatic.shopHuman[11].SetActive(true);
	...
	public IEnumerator TimeForPointerDown(){
		...
		if(isPressDown){
			...
			//現在のヒトの日誌番号
			ShopStatic.shopNowDiaryHumanNumber = 11;

			//日誌を表示、背景タブを表示
			ShopStatic.shopHumanExplainTab[11].SetActive(true);
