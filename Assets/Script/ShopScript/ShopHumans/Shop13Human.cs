...
public class Shop13Human : MonoBehaviour {
	...
	long thisHumanPriceRainbow = 500;
	...
	public void OnClicking(){
		...
		if(isPressUp == true){
			...
			//確認画面でヒトの画像を表示する
			ShopStatic.shopHuman[13].SetActive(true);
	...
	public IEnumerator TimeForPointerDown(){
		...
		if(isPressDown){
			...
			//現在のヒトの日誌番号
			ShopStatic.shopNowDiaryHumanNumber = 13;

			//日誌を表示、背景タブを表示
			ShopStatic.shopHumanExplainTab[13].SetActive(true);
