...
public class ShopTree4 : MonoBehaviour {
	...
	public void OnClicking(){
		...
		if(isPressUp == true){
			...
			//確認画面で木の画像を表示する
			ShopStatic.shopTree[4].SetActive(true);
	...
	public IEnumerator TimeForPointerDown(){
		...
		if(isPressDown){
			...
			//現在の木の日誌番号
			ShopStatic.shopNowDiaryTreeNumber = 4;

			//日誌を表示、背景タブを表示
			ShopStatic.shopTreeExplainTab[4].SetActive(true);
