...
public class ShopTree11 : MonoBehaviour {
    ...
    //この木の１００万本の値段
	long thisTreePrice = 6190000000;
	long thisTreePriceRainbow = 47;
	...
	public void OnClicking(){
		...
		if(isPressUp == true){
			...
			//確認画面で木の画像を表示する
			ShopStatic.shopTree[11].SetActive(true);
	...
	public IEnumerator TimeForPointerDown(){
		...
		if(isPressDown){
			...
			//現在の木の日誌番号
			ShopStatic.shopNowDiaryTreeNumber = 11;

			//日誌を表示、背景タブを表示
			ShopStatic.shopTreeExplainTab[11].SetActive(true);
